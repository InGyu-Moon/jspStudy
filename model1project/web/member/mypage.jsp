...
<%@ page import="org.example.data.dao.MemberDao" %>
<%@ page import="org.example.data.dto.MemberDto" %>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td rowspan="6" style="width: 150px;" align="center" valign="middle">
                <button type="button" class="btn btn-outline-info" onclick="location.href='index.jsp?main=member/updatepassform.jsp?num=<%=dto.getNum()%>'" >수정</button><br><br>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content ">
            ...
            <div class="modal-footer">
                <button id="btndel" type="button" class="btn btn-danger" data-bs-dismiss="modal">삭제</button>
            </div>

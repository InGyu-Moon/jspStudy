...
<%@ page import="org.example.data.dao.GuestDao" %>
<%@ page import="org.example.data.dto.GuestDto" %>
<%@ page import="java.util.List" %>
<%@ page import="org.example.data.dao.MemberDao" %>
<%@ page import="org.example.data.dao.AnswerGuestDao" %>
<%@ page import="org.example.data.dto.AnswerGuestDto" %>
...
<b>총 <%=totalCount %>개의 방명록 글이 있습니다</b>
  ...
  <%
    ...
    {
    	//이름얻기
    	String name=mdao.getNameById(dto.getMyid());
    	%>
    	                 ...
    	                 {%>
    	                	 <tr>
    	                	   ...
    	                	   <td>
    	                	      ...
    	                	      <%
    	                	        //작성자명
    	                	        String aname=mdao.getNameById(adto.getMyid());
    	                	      %>
    	                	      <br>
    	                	      <b><%=aname %></b>
    	                	      &nbsp;

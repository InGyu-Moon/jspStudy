...
<body>
<form action="writeForm_01.jsp" method="post">
   <table class="table table-bordered" style="width: 50%">
      ...
      <tr height="30">
         <td>
            ...
            <select name="like">
               ...
               <option value="유리" selected>유리</option>
      ...
      <tr>
         <td align="center">
            <input type="submit" value="전송" class="btn btn-info" width="100px">
            <input type="reset" value="초기화" class="btn btn-danger" width="100px">
         </td>
      </tr>
